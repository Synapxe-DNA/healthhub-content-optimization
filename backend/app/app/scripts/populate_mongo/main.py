...
async def __main():
    ...
    edges_file_path = os.path.join('app','data','all-mpnet-base-v2_neo4j_edges.pkl')   #To be edited
    cluster_file_path = os.path.join('app','data','all-mpnet-base-v2_neo4j_pred_cluster.pkl') #To be edited
    db_populator = DBPopulator(conn, articles_file_path, edges_file_path, cluster_file_path)
